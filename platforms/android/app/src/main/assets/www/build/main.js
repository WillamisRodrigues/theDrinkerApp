...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__home_home__ = __webpack_require__(53);
...
var RegisterPage = (function () {
    ...
    RegisterPage.prototype.signup = function () {
        ...
        this.authService.register(this.userInfo).subscribe(function () {
            loading.dismiss();
            _this.alertCtrl.create({ message: 'Account Created Successfully', buttons: ['OK'] }).present();
        }, function (error) {
            loading.dismiss();
...
var DEFAULT_AVATAR = './assets/img/default-dp.png';
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__pages_home_home__ = __webpack_require__(53);
...
var HomePage = (function () {
    ...
    HomePage.prototype.confirmJob = function () {
        var _this = this;
        console.log("confirm");
        var message = "<b>From:</b> (" + this.job.origin.distance + "km)<br/>" + this.job.origin.vicinity + "<br/><br/> <b>To:</b>(" + this.job.destination.distance + "km)<br>" + this.job.destination.vicinity + "";
